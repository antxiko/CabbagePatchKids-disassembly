...
**El juego no es nuestro.** *Cabbage Patch Kids* lo publico **Konami** para MSX en 1984; su
numero de catalogo es **RC-716** y son 16 KB. Todos los derechos sobre el juego
...
El fichero `src/cabbagepatch.asm` es el desensamblado comentado del cartucho. Se publica
...
Si trabajaste en *Cabbage Patch Kids* o tienes derechos sobre el juego, y preferirias que este
