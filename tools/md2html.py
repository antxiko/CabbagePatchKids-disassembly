...
PIE = {
    "es": "<em>Cabbage Patch Kids</em> lo publico Konami para MSX; su numero de catalogo es RC-716 y son 16 KB. Todos los derechos sobre el juego siguen siendo de sus titulares. Este trabajo es de preservacion, estudio y documentacion, y la imagen del cartucho no se distribuye.",
    "en": "<em>Cabbage Patch Kids</em> was published by Konami for the MSX; its catalogue number is RC-716 and it is 16 KB. All rights in the game remain with their holders. This is preservation, study and documentation work, and the cartridge image is not distributed.",
}
...
REPO = os.environ.get("CABBAGEPATCH_REPO",
                      "https://github.com/antxiko/CabbagePatchKids-disassembly")
...
def main(docdir, idioma="en"):
    ...
    for fn in sorted(os.listdir(docdir)):
        ...
        titulo = (m.group(1) if m else fn[:-3]) + " — Cabbage Patch Kids (Konami, 1984)"
