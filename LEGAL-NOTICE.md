...
**The game is not ours.** *Cabbage Patch Kids* was published by **Konami** for the MSX in 1984;
its catalogue number is **RC-716** and it is 16 KB. All rights over the game
...
The file `src/cabbagepatch.asm` is the commented disassembly of the cartridge. It is
...
If you worked on *Cabbage Patch Kids* or hold rights over the game, and you would rather this
